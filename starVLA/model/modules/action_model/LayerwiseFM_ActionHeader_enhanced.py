...
class LayerwiseFlowmatchingActionHead(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.num_inference_timesteps = action_config.num_inference_timesteps # Num denoise steps

        # One state to one embedding
        self.state_encoder = MLP(
            input_dim=action_config.state_dim,
            output_dim=self.input_embedding_dim,
        ) if action_config.state_dim else None

        # TODO: why need action_encoder for flow matching
        ...
        # NOTE: so far not used for loss, it is originally proposed by groot n1.5
    ...
    def forward(self, vl_embs_list: list, actions: torch.Tensor, state: torch.Tensor = None):
        ...
        # NOTE: concate at the front, but not used
        ...
        # TODO by starVLA author: miss self att and _process_output, but work well
