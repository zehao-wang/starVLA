...
#
# Usage (single-node):
#   MACHINE=l40s bash run_simplerenv_train_qwen35_gr00t_delta16.sh
#   MODE=debug   bash run_simplerenv_train_qwen35_gr00t_delta16.sh
# ---------------------------------------------------------------------------
...
config_yaml=./examples/vc_simplerenv_qwen35/train_files/starvla_cotrain_simplerenv_qwen35_gr00t.yaml
...
run_id=260412_${machine}_${data_mix}_qwen35_gr00t_simplerenv
