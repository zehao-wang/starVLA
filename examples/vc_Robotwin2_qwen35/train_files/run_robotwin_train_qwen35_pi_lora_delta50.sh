...
run_id=260403_${machine}_${data_mix}_qwen35_pi_lora_delta50_c40r10
...
# NOTE: `datasets.vla_data.action_type` is currently unused by the dataloader/training path.
# Keep it for compatibility/documentation only.
accelerate launch \
