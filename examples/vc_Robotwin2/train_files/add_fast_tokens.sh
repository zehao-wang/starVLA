...
# Usage: bash examples/vc_Robotwin2/train_files/add_fast_tokens.sh <source_model_dir> <target_model_dir>
# Example: bash add_fast_tokens.sh playground/Pretrained_models/Qwen3-VL-4B-Instruct \
...
ADD_TOKENS_SCRIPT=starVLA/model/modules/vlm/tools/add_qwen_special_tokens/add_special_tokens_to_qwen.py
