# ---------------------------------------------------------------------------
# MACHINE config  — select with: MACHINE=a100 bash run_robotwin_train_qwen3vl_pi_lora.sh
# ---------------------------------------------------------------------------
...
MODE=${MODE:-train}   # usage: MODE=debug bash run_robotwin_train_qwen3vl_pi_lora.sh

Framework_name=QwenPI
# VLM backbone is frozen by PEFT LoRA (attention + MLP projections only).
# Vision encoder is not affected. action_model (LayerwiseFM) is fully trainable.
freeze_module_list=''
base_vlm=playground/Pretrained_models/Qwen3-VL-4B-Instruct
config_yaml=./examples/vc_Robotwin2/train_files/starvla_cotrain_robotwin_qwen3vl_pi_lora.yaml
...
run_id=0330_${data_mix}_qwen3pi_lora_c40r10
